...
public class GoodsDetailTitleAdapter extends FragmentPagerAdapter {
    private String[] titleArray;
    private List<Fragment> fragmentList;

    public GoodsDetailTitleAdapter(FragmentManager fm, List<Fragment> fragmentList, String[] titleArray) {
        super(fm);
